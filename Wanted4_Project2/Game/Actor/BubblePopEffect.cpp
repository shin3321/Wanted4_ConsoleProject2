#include "BubblePopEffect.h"
#include "Engine/Engine.h"

// 효과 재생에 사용할 문자열 시퀀스 (일종의 애니메이션 프레임).
static const BubblePopEffect::EffectFrame sequence[] =
{
	BubblePopEffect::EffectFrame("@", 0.08f, Color::Red),
	BubblePopEffect::EffectFrame("@", 0.08f, Color::Blue),
	BubblePopEffect::EffectFrame("@", 0.08f, Color::Green),
	BubblePopEffect::EffectFrame("@", 0.08f, Color::Red)
};

BubblePopEffect::BubblePopEffect(const Vector2& position)
...
void BubblePopEffect::Tick(float deltaTime)
{
